...
import net.labymedia.ultralight.input.UltralightKeyEvent;
import net.labymedia.ultralight.input.UltralightMouseEvent;
import net.labymedia.ultralight.input.UltralightScrollEvent;
import net.labymedia.ultralight.javascript.JavascriptContextLock;
import net.labymedia.ultralight.javascript.JavascriptEvaluationException;
...
import net.labymedia.ultralight.input.UltralightKeyEventType;
